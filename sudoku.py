...
# TODO: Строку нужно будет получать иначе - из файла, командной строки или интерактивно, туда же — проверу ввода.
#   (СТРОГО ЖЕЛАТЕЛЬНО — интерактивно)
# TODO: добавить исключение возможного значения без собственно его простановки
